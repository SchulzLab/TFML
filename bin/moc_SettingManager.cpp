/****************************************************************************
** Meta object code from reading C++ file 'SettingManager.hpp'
**
...
#include "../TFML/src/SettingManager.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'SettingManager.hpp' doesn't include <QObject>."
...
const QMetaObject SettingManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SettingManager.data,
      qt_meta_data_SettingManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SettingManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SettingManager.stringdata0))
        return static_cast<void*>(const_cast< SettingManager*>(this));
